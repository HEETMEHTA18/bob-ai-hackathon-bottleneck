"""
Bottleneck — Orchestrator service.

Single entry point for computing all Bottleneck outputs for one or all assets.
...
from backend.bottleneck.mock_data import (
...
from backend.bottleneck.risk_engine import (
